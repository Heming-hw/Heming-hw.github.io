...
exports["templates"]["controls"] = Handlebars.template({ "1": function _(container, depth0, helpers, partials, data) {
        ...
        return "<div class=\"vac-video-cover vac-control\">\n    <div class=\"vac-video-cover-canvas\">\n        <div class=\"vac-cursor-tool-tip vac-hidden\">Click and drag to select</div>\n    </div>\n</div>\n" + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "showControls") : depth0, { "name": "if", "hash": {}, "fn": container.program(6, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 21, "column": 0 }, "end": { "line": 33, "column": 7 } } })) != null ? stack1 : "") + "\n" + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "writingComment") : depth0, { "name": "if", "hash": {}, "fn": container.program(9, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 35, "column": 0 }, "end": { "line": 70, "column": 7 } } })) != null ? stack1 : "") + "\n\n" + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "showTemplates") : depth0, { "name": "if", "hash": {}, "fn": container.program(11, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 73, "column": 0 }, "end": { "line": 116, "column": 7 } } })) != null ? stack1 : "");
        ...
        return "<div class=\"vac-video-write-new-wrap vac-control\">\n    <div class=\"vac-video-write-new vac-is-annotation\">\n        <div>\n            <h5><b>New Annotation</b> @ " + alias4((helper = (helper = lookupProperty(helpers, "rangeStr") || (depth0 != null ? lookupProperty(depth0, "rangeStr") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "rangeStr", "hash": {}, "data": data, "loc": { "start": { "line": 39, "column": 40 }, "end": { "line": 39, "column": 52 } } }) : helper)) + "</h5>\n            <br></br>\n            <div class=\"dropdown\">\n            <button>Templates</button>\n                <div class=\"dropdown-content\">\n                    <a class=\"vac-emboli-template\">Emboli</a>\n                    <a class=\"vac-bubble-template\">Bubble</a>\n                </div>\n            </div>\n\n            <div class=\"vac-comment-showbox\">\n                <textarea placeholder=\"Enter comment...\">" + alias4((helper = (helper = lookupProperty(helpers, "templateContent") || (depth0 != null ? lookupProperty(depth0, "templateContent") : depth0)) != null ? helper : alias2, (typeof helper === "undefined" ? "undefined" : _typeof(helper)) === alias3 ? helper.call(alias1, { "name": "templateContent", "hash": {}, "data": data, "loc": { "start": { "line": 58, "column": 57 }, "end": { "line": 58, "column": 76 } } }) : helper)) + "</textarea>\n                <div>\n                    <button class='vac-button vac-save-button'>SAVE</button>\n                    <a class=\"vac-cancel-add-new\">Cancel</a>\n                </div>\n            </div>\n\n            \n\n        </div>\n    </div>\n</div>\n";
        ...
        return "<div class=\"vac-video-write-new-wrap vac-control\">\n    <div class=\"vac-video-write-new vac-is-annotation\">\n        <div>\n            <h5><b>New Annotation</b> @ " + container.escapeExpression((helper = (helper = lookupProperty(helpers, "rangeStr") || (depth0 != null ? lookupProperty(depth0, "rangeStr") : depth0)) != null ? helper : container.hooks.helperMissing, typeof helper === "function" ? helper.call(alias1, { "name": "rangeStr", "hash": {}, "data": data, "loc": { "start": { "line": 77, "column": 40 }, "end": { "line": 77, "column": 52 } } }) : helper)) + "</h5>\n            <div class=\"vac-comment-showbox\">\n                \n\n" + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "showEmboliTemplate") : depth0, { "name": "if", "hash": {}, "fn": container.program(12, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 81, "column": 16 }, "end": { "line": 92, "column": 23 } } })) != null ? stack1 : "") + "\n" + ((stack1 = lookupProperty(helpers, "if").call(alias1, depth0 != null ? lookupProperty(depth0, "showBubbleTemplate") : depth0, { "name": "if", "hash": {}, "fn": container.program(14, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 94, "column": 16 }, "end": { "line": 107, "column": 23 } } })) != null ? stack1 : "") + "                <div>\n                    <button class=\"vac-template-save\">SAVE</button>\n                    <a class=\"vac-cancel-template\">Cancel</a>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n";
    }, "12": function _(container, depth0, helpers, partials, data) {
        return "                <br><br>\n                <label style=\"color:black\">Emboli Count (Right):  </label>\n                <input type=\"text\" placeholder=\"Enter Value\"></input>\n                <br><br>\n                <label style=\"color:black\">Emboli Count (Left):  </label>\n                <input type=\"text\" placeholder=\"Enter Value\"></input>\n                <br><br>\n                <label style=\"color:black\">Emboli Count (Bilateral):  </label>\n                <input type=\"text\" placeholder=\"Enter Value\"></input>3\n                <br><br>\n";
    }, "14": function _(container, depth0, helpers, partials, data) {
        return "                <br><br>\n                <label style=\"color:black\">Resting Injection:  </label>\n                <input type=\"text\" placeholder=\"Enter bubble count\"></input>\n                <br><br>\n                <label style=\"color:black\">Type:  </label>\n                <input type=\"text\" placeholder=\"Choose\"></input>\n                <br><br>\n                <label style=\"color:black\">Valsalva Strain  </label>\n                <input type=\"text\" placeholder=\"Enter bubble count\"></input>3\n                <br><br>\n                \n\n";
...
var BASE_UI_STATE = Object.freeze({
  ...
  showEmboliTemplate: false,
  showBubbleTemplate: false
...
module.exports = function (_PlayerUIComponent) {
  ...
  _createClass(Controls, [{
    ...
    value: function bindEvents(bindArrowKeys) {
      ...
      .on('click.vac-controls', '.vac-cancel-marker', this.cancelAddNew.bind(this)); // click "cancel" link when making mark 
      if (this.internalCommenting) {
        this.$player.on('click.vac-controls', '.vac-add-controls button', this.writeComment.bind(this)) // 'continue' button click while adding
        .on('click.vac-controls', '.vac-emboli-template', this.addEmboliTemplate.bind(this)) // clicked "add Emboli template" link
        .on('click.vac-controls', '.vac-bubble-template', this.addBubbleTemplate.bind(this)) // clicked "add Bubble template" link
        .on('click.vac-controls', '.vac-template-save', this.templateSave.bind(this)) // clicked "save" when adding template
        .on('click.vac-controls', '.vac-save-button', // used to be '.vac-video-write-new.vac-is-annotation button',
        this.saveNew.bind(this)) // 'Save' button click while adding
        .on('click.vac-controls', ".vac-cancel-add-new", // '.vac-add-controls a, .vac-video-write-new.vac-is-annotation a',
        this.cancelAddNew.bind(this)) // Cancel link click
        .on('click.vac-controls', ".vac-cancel-template", this.cancelTemplate.bind(this));
      }
      if (bindArrowKeys) {
    ...
    // User clicked "Emboli template" link

  }, {
    key: 'addEmboliTemplate',
    value: function addEmboliTemplate() {
      // alert("hiii")
      this.uiState.showTemplates = true;
      this.uiState.showEmboliTemplate = true;
      this.uiState.showBubbleTemplate = false;
      this.render();
    }

    // User clicked "Bubble template" link

  }, {
    key: 'addBubbleTemplate',
    value: function addBubbleTemplate() {
      this.uiState.showTemplates = true;
      this.uiState.showBubbleTemplate = true;
      this.uiState.showEmboliTemplate = false;
      this.render();
    }
    ...
    key: 'templateSave',
    value: function templateSave() {
      // reassign the templateContent to empty string (to due with re-using the template)
      this.templateContent = "";

      // get input array
      var inputs = this.$UI.templateInputs;

      // get label array
      var labels = this.$UI.templateLabels;
